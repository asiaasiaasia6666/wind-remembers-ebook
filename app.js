(function () {
  ...
  const CHAPTER_ILLUSTRATIONS = {
    0: [{ src: 'assets/images/chapter-01.jpg', after: '我一下子慌了', alt: '教室里，男生拿着背诵检查名单，女生站在课桌旁', caption: '名单上的对勾迟了一点，也让这段记忆停得更久。' }],
    1: [{ src: 'assets/images/chapter-02.jpg', after: '程明夏站在那里', alt: '女生站在高中教室门口，男生从座位上望向她', caption: '她站在新教室门口，把他重新算进“我们几个”里面。' }],
    2: [{ src: 'assets/images/chapter-03.jpg', after: '我忽然觉得，这里很浪漫', alt: '县城披萨店里，少年望向靠窗的一张空桌', caption: '那张没有等到她的桌子，陪他走过了整个高中。' }],
    3: [{ src: 'assets/images/chapter-04.jpg', after: '暗恋许宁', alt: '模考教室里，男生望着墙上写有暗恋字样的红纸', caption: '三行红纸上的字，让一个人的兵荒马乱忽然有了名字。' }],
    4: [{ src: 'assets/images/chapter-05.jpg', after: '她穿了一条白色长裙', alt: '毕业季，穿白裙的女生和白衬衫男生并肩站在校园里', caption: '快门只响了一次，白裙和没说出口的话都留在了那天。' }],
    5: [{ src: 'assets/images/chapter-06.jpg', after: '程明夏遇到一道不会的数学题', alt: '高考前，女生和男生坐在桌边一起复习', caption: '最后一周，他们离答案很近，离那句话仍然很远。' }],
    7: [{ src: 'assets/images/chapter-08.jpg', after: '我舍不得停下每天的早安晚安', alt: '熄灯后的大学宿舍里，男生躺在床上看手机', caption: '九月的屏幕微光，把普通问候照得像某种靠近。' }],
    8: [
      { src: 'assets/images/chapter-09-night.jpg', after: '手机屏幕朝着脸', alt: '深夜宿舍里，男生独自坐在床沿，手机放在一旁', caption: '话终于发送出去，等待却比漫长的暗恋更安静。' },
      { src: 'assets/images/chapter-09-road.jpg', after: '她坐我的车', alt: '秋日校园外，男生骑电动车载着女生经过旧学校', caption: '答案没有改变，晚风却仍把那段路吹得很温柔。' }
    ],
    11: [{ src: 'assets/images/chapter-12.jpg', after: '我点开链接', alt: '窗边书桌前，男生认真用手机填写课程问卷', caption: '许多年后，他终于懂得：认真回应，也可以不再借机挽留。' }]
  };
  ...
  function renderChapter(index) {
    ...
    document.title = `${chapter.title}｜晚风替我记得`;
